...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw", help="Show raw results (not just Pareto frontier) in faded colours", action="store_true")
    parser.add_argument(
        "--batch-size",
    ...
    results = load_all_results(args.dataset, count, args.batch, args.batch_size)
